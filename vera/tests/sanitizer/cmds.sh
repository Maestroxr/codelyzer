...
clang -g -fsanitize=address -fno-omit-frame-pointer sanitizer_address-segmentation_fault.c -o sanitizer_address-segmentation_fault
...
(time ./sanitizer_address-segmentation_fault) &> sanitizer_address-segmentation_fault.log
